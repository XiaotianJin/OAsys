...
namespace SpringFramework.UI
{
    ...
    [System.Serializable]
    public class DWEPieData
    {
        public float Percent;
        public Color Color;
        public DWEPieData(){}
        public DWEPieData(float percent,Color color0)
        {
        ...
        public DWEPieData(float percent)
        {
            Percent = percent / 100.0f;
    ...
    [System.Serializable]
    public class DWEPies
    {
        public List<DWEPieData> PieDatas = null;
        public DWEPies(){}
        public DWEPies( List<DWEPieData> pieDatas )
        {
            PieDatas = pieDatas;
        }
    };
    ...
    [System.Serializable]
    public class DWEPieText
    {
        public string Content = null;
        public Vector2 Position;
        public bool IsLeft = true;
        public DWEPieText(){}
        public DWEPieText( string content,Vector2 position ,bool isLeft )
        {
            Content = content;
            Position = position;
            IsLeft = isLeft;
    ...
    /// 核心类型
    /// </summary>
    public class DWEPieGraph : MaskableGraphic
    {
        [Tooltip("圆环半径")]
        ...
        private DWEPies PieData = null;
        private List<DWEPieText> _pieText = null;
        ...
        {
            PieData = new DWEPies(new List<DWEPieData>()
            {
                new DWEPieData(70 ,Color.white),
                new DWEPieData(10,Color.magenta),
                new DWEPieData(10 ,Color.red),
                new DWEPieData(10 ,Color.blue),
                //new DWEPieData(15 ,Color.black),
        ...
        private void OnGUI()
        {
            ...
            foreach ( DWEPieText text in _pieText )
            {
